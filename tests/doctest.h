...
#define DOCTEST_PARSE_STR_OPTION(name, sname, var, default)                                        \
    ...
    // UINT_MAX caused compilation errors
    DOCTEST_PARSE_INT_OPTION("last", "l", last, std::numeric_limits<unsigned int>::max());

    DOCTEST_PARSE_INT_OPTION("abort-after", "aa", abort_after, 0);
    // INT_MAX caused compilation errors
    DOCTEST_PARSE_INT_OPTION("subcase-filter-levels", "scfl", subcase_filter_levels, std::numeric_limits<int>::max());
